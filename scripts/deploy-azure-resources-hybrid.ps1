...
Write-Info "1. Configure GitHub secrets and variables (automated):"
Write-Info "   .\configure-github-cicd.ps1 -GitHubRepository '$GitHubRepository'"
Write-Info "2. OR configure manually:"
Write-Info "   a) Add secrets: Repository Settings → Secrets and variables → Actions → Secrets"
Write-Info "   b) Add variables: Repository Settings → Secrets and variables → Actions → Variables"
